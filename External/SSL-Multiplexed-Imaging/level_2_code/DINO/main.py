...
class DINO(pl.LightningModule):
    def __init__(self, args):
        ...
        backbone.patch_embed = PatchEmbed(args, embed_dim=768)
        backbone.pos_embed = nn.Parameter(torch.zeros_like(backbone.pos_embed)) # Remove positional encoding as there is no meaning in arbitrary feature images
...
def parse_arguments():
    ...
    parser.add_argument('--batch_size', type=int, default=40, help='Batch size for training (default: 128)')
    
    parser.add_argument('--max_epochs', type=int, default=200, help='Maximum number of epochs (default: 100)')
